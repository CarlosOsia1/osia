...
/**
 * RemotePlayers (S0.5-H3) — renderiza un avatar por cada entidad remota,
 * interpolado con render-delay (~100 ms) entre snapshots para movimiento fluido.
 * El roster (join/leave) viene del store; las posiciones, por refs en useFrame.
 */
