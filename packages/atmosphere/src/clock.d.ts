...
export declare const CYCLE_SECONDS = 1800;
/** timeOfDay 0..1 a partir de un instante (ms epoch) y la duración del ciclo. */
export declare function timeOfDayAt(epochMs: number, cycleSeconds?: number): number;
/**
...
export declare const CYCLES_PER_YEAR = 384;
/**
 ...
 */
export declare function timeOfYearAt(epochMs: number, cycleSeconds?: number, cyclesPerYear?: number): number;
