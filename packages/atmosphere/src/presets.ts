...
export const CELESTIAL_CYCLE: AtmosphereKeyframe[] = [
  ...
  { t: 0.302, name: 'manana-temprana', params: p({ skyTop: '#6f86b0', skyHorizon: '#d8c3a6', fog: '#cdbfae', fogDensity: 0.014, sunColor: '#ecc89a', sunIntensity: 1.9, moonColor: MOON, moonIntensity: 0.03, ambientColor: '#b6a48e', ambientIntensity: 0.5, exposure: 1.0, bloom: 0.5, stars: 0.04 }) },
  { t: 0.333, name: 'dia', params: p({ skyTop: '#4f87c6', skyHorizon: '#c6c4b0', fog: '#cdc8b6', fogDensity: 0.006, sunColor: '#f3e3c4', sunIntensity: 2.6, moonColor: MOON, moonIntensity: 0, ambientColor: '#c0bcab', ambientIntensity: 0.5, exposure: 1.02, bloom: 0.32, stars: 0 }) },
  { t: 0.625, name: 'dia-tardio', params: p({ skyTop: '#4f87c6', skyHorizon: '#c6c4b0', fog: '#cdc8b6', fogDensity: 0.006, sunColor: '#f3e3c4', sunIntensity: 2.6, moonColor: MOON, moonIntensity: 0, ambientColor: '#c0bcab', ambientIntensity: 0.5, exposure: 1.02, bloom: 0.32, stars: 0 }) },
  { t: 0.688, name: 'pre-atardecer', params: p({ skyTop: '#3f6fa8', skyHorizon: '#d8b488', fog: '#b89878', fogDensity: 0.009, sunColor: '#f0cf94', sunIntensity: 2.2, moonColor: MOON, moonIntensity: 0, ambientColor: '#a89070', ambientIntensity: 0.48, exposure: 1.02, bloom: 0.45, stars: 0 }) },
