...
export const CELESTIAL_CYCLE: AtmosphereKeyframe[] = [
  ...
  { t: 0.625, name: 'dia-tardio', params: p({ skyTop: '#357fd8', skyHorizon: '#82b9e9', fog: '#aed2ef', fogDensity: 0.006, sunColor: '#f3e3c4', sunIntensity: 2.6, moonColor: MOON, moonIntensity: 0, ambientColor: '#c0bcab', ambientIntensity: 0.5, exposure: 1.02, bloom: 0.32, stars: 0 }) },
