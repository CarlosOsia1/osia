...
export function timeOfDayAt(epochMs, cycleSeconds = CYCLE_SECONDS) {
 ...
 */
export function timeOfYearAt(epochMs, cycleSeconds = CYCLE_SECONDS, cyclesPerYear = CYCLES_PER_YEAR) {
