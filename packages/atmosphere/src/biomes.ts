...
const TUNDRA_CYCLE: AtmosphereKeyframe[] = [
  ...
  { t: 0.333, name: 'dia', params: mk({ skyTop: '#3f80c6', skyHorizon: '#b6c8d8', fog: '#bcc8d4', fogDensity: 0.008, sunColor: '#f2f6fa', sunIntensity: 2.4, moonColor: T_MOON, moonIntensity: 0, ambientColor: '#bdcad6', ambientIntensity: 0.55, exposure: 1.0, bloom: 0.34, stars: 0 }) },
  { t: 0.625, name: 'dia-tardio', params: mk({ skyTop: '#3f80c6', skyHorizon: '#b6c8d8', fog: '#bcc8d4', fogDensity: 0.008, sunColor: '#f2f6fa', sunIntensity: 2.4, moonColor: T_MOON, moonIntensity: 0, ambientColor: '#bdcad6', ambientIntensity: 0.55, exposure: 1.0, bloom: 0.34, stars: 0 }) },
...
const DUNES_CYCLE: AtmosphereKeyframe[] = [
  ...
  { t: 0.333, name: 'dia', params: mk({ skyTop: '#4a84c2', skyHorizon: '#d9bf86', fog: '#d4bf90', fogDensity: 0.009, sunColor: '#f8ecc4', sunIntensity: 2.7, moonColor: D_MOON, moonIntensity: 0, ambientColor: '#ccb98c', ambientIntensity: 0.58, exposure: 1.04, bloom: 0.4, stars: 0 }) },
  { t: 0.625, name: 'dia-tardio', params: mk({ skyTop: '#4a84c2', skyHorizon: '#d9bf86', fog: '#d4bf90', fogDensity: 0.009, sunColor: '#f8ecc4', sunIntensity: 2.7, moonColor: D_MOON, moonIntensity: 0, ambientColor: '#ccb98c', ambientIntensity: 0.58, exposure: 1.04, bloom: 0.4, stars: 0 }) },
