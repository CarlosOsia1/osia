 ...
 */
import { makeParams as p } from './params';
const MOON = '#aeb6cc';
/** Bosque Celeste: alma de marca, champán sobre ónix. */
export const CELESTIAL_CYCLE = [
    ...
    { t: 0.333, name: 'dia', params: p({ skyTop: '#0056c0', skyHorizon: '#50a1e7', fog: '#aed2ef', fogDensity: 0.006, sunColor: '#f3e3c4', sunIntensity: 2.6, moonColor: MOON, moonIntensity: 0, ambientColor: '#abbfc0', ambientIntensity: 0.5, exposure: 1.02, bloom: 0.32, stars: 0 }) },
    { t: 0.625, name: 'dia-tardio', params: p({ skyTop: '#357fd8', skyHorizon: '#6baae0', fog: '#aed2ef', fogDensity: 0.006, sunColor: '#f3e3c4', sunIntensity: 2.6, moonColor: MOON, moonIntensity: 0, ambientColor: '#c0bcab', ambientIntensity: 0.5, exposure: 1.02, bloom: 0.32, stars: 0 }) },
