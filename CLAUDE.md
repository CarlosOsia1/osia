...
- **Fase 3.5 — La Red Social: Capa de Experiencia (UX de lujo): ✅ FUNCIONALMENTE CERRADA (2026-07-01).** Sub-fase pedida
  ...
  **Progreso (avanza HU por HU, en orden; todo verde y en cloud):**
  ...
  - `S3.4` Presencia + Notificaciones ✅ **CERRADO** — H2 ✅ notificaciones: el bus interno conecta los
    ...
    · H1 ✅ presencia: `GET /v1/presence?accountIds=…` lee el checkpoint `world.presence_sessions` (open=
